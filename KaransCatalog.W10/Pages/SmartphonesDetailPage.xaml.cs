//---------------------------------------------------------------------------
//
// <copyright file="SmartphonesDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class SmartphonesDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public SmartphonesDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new SmartphonesSection());
