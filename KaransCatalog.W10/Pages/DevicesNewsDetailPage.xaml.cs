//---------------------------------------------------------------------------
//
// <copyright file="DevicesNewsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DevicesNewsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DevicesNewsDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new DevicesNewsSection());
