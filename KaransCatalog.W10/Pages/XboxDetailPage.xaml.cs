//---------------------------------------------------------------------------
//
// <copyright file="XboxDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class XboxDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public XboxDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new XboxSection());
