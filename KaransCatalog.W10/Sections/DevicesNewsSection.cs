...
{
    public class DevicesNewsSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public DevicesNewsSection()
		{
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.DevicesNewsListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.DevicesNewsDetailPage>(true);
                    }
                };
            }
        }
